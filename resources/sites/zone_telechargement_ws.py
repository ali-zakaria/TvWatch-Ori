...
def load():
    ...
    oOutputParameterHandler = cOutputParameterHandler()
    oGui.addDir(SITE_IDENTIFIER, 'showSeries', util.VSlang(30121), 'films_hd.png', oOutputParameterHandler) # Series
...
def showFilms():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30426), 'films_news.png', oOutputParameterHandler) #Nouveautés

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', MOVIE_EXCLUS[0])
    oOutputParameterHandler.addParameter('movie', "True")
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30427), 'news.png', oOutputParameterHandler) #Populaires
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30428), 'films_hd.png', oOutputParameterHandler) #Blu-rays

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', MOVIE_3D[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30429), 'news.png', oOutputParameterHandler) #Films 3D

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', MOVIE_HDLIGHT[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30430), 'films_hd.png', oOutputParameterHandler) #Films HDLight

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', MOVIE_4K[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30431), 'films_hd.png', oOutputParameterHandler) #Films 4K
...
def showSeries():
    ...
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30433), 'series_vf.png', oOutputParameterHandler) #Séries VF

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', SERIE_VOSTFRS[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30434), 'series_vostfr.png', oOutputParameterHandler) #Séries VOSTFR

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', ANIM_VFS[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30435), 'animes_vf.png', oOutputParameterHandler) #Dessins Animés VF

    oOutputParameterHandler = cOutputParameterHandler()
    oOutputParameterHandler.addParameter('siteUrl', ANIM_VOSTFRS[0])
    oGui.addDir(SITE_IDENTIFIER, 'showMovies', util.VSlang(30436), 'animes_vostfr.png', oOutputParameterHandler) #Dessins Animés VOSTFR
...
def showSeriesLinks():
    ...
    if currentSeason != 0:
        oGui.addText(SITE_IDENTIFIER,'[COLOR khaki]Continuer à regarder :[/COLOR]')
        stop = False
    else:
        oGui.addText(SITE_IDENTIFIER,'[COLOR khaki]Saisons disponibles pour cette série :[/COLOR]')
...
def showSeriesHosters(params = ['','','']):# recherche et affiche les hotes
    ...
    if (aResult[0] == True):
        ...
        for aEntry in entries:
            ...
            if aEntry[0]:
                ...
                if "Episode" in sTitle:
                    episode = sTitle[sTitle.find("Episode")+7:].replace(" ","")
        ...
        if int(currentEpisode) != 0:
            ...
            oGui.addText(SITE_IDENTIFIER,'[COLOR khaki]Episodes disponibles pour cette saison :[/COLOR]')
        for episode in episodes:
            ...
            if not stop:
                oGui.addText(SITE_IDENTIFIER,'[COLOR khaki]Autres episodes disponibles pour cette saison :[/COLOR]')
                stop = True
...
def sortSeasonsAndGetCurrentSeason(seasons):
    stop = False
    res = cDb().get_historyFromTitle(seasons[0]['sMovieTitle'])
    currentSeason = 0
    currentEpisode = 0
    while not stop:
        stop = True
    ...
    if res:
        ...
        for i in range(len(seasons)):
            ...
            if title == seasons[i]['sMovieTitle']:
                currentEpisode = int(res[3][res[3].find("Episode ")+8:].replace(" ",""))
